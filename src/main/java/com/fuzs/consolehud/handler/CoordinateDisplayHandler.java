...
public class CoordinateDisplayHandler {
    ...
    public void renderGameOverlayPre(RenderGameOverlayEvent.Pre evt) {
        ...
        int width = this.mc.fontRendererObj.getStringWidth(component.getUnformattedText());
        ...
        this.mc.fontRendererObj.drawStringWithShadow(component.getFormattedText(), x + i, y + i, 16777215 + (f << 24));
