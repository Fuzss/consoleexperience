...
public class SaveIconHandler extends GuiIngame {
    ...
    public void renderGameOverlayPre(RenderGameOverlayEvent.Pre evt) {
        ...
        if (this.remainingDisplayTicks > 0) {
            ...
            int k = position.getX(this.width, this.mc.mainWindow.getScaledWidth(), ConfigHandler.SAVE_ICON_CONFIG.xOffset.get());
            int l = position.getY(this.height, this.mc.mainWindow.getScaledHeight(), ConfigHandler.SAVE_ICON_CONFIG.yOffset.get());
