...
public class CloseButton extends Button {
    ...
    public void renderButton(int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.isTopSmall) {
            ...
            this.blit(this.x + 1, this.y + 1, 1, this.isHovered() ? this.height + 1 : 1, this.width - 2, this.height - 2);
        } else {

            this.blit(this.x, this.y, 0, this.isHovered() ? this.height : 0, this.width, this.height);
        }
    }
