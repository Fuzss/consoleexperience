...
import com.fuzs.consoleexperience.mixin.client.accessor.ConnectingScreenAccessor;
import com.fuzs.consoleexperience.mixin.client.accessor.ScreenAccessor;
...
public class FancyConnectingScreen {
    ...
    public static void render(Minecraft minecraft, MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks, ConnectingScreen connectingScreen) {
        ...
        FancyScreenUtil.drawCenteredString(matrixStack, Minecraft.getInstance().fontRenderer, ((ConnectingScreenAccessor) connectingScreen).getConnectingProgress(), width, height);
