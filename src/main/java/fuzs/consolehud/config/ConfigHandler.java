...
public class ConfigHandler {
    ...
    private static void loadConfiguration() {
        ...
        heldItemTooltipsBottomMargin = config.getInt("Advanced Held Item Tooltips Margin", categoryGeneral, 59, 0, 2147483647, "Margin for last row from screen bottom.");
        ...
        paperDollXMargin = config.getInt("Paper Doll X-Margin", categoryGeneral, 0, -2147483647, 2147483647, "Margin on x-axis from original doll position.");
        paperDollYMargin = config.getInt("Paper Doll Y-Margin", categoryGeneral, 0, -2147483647, 2147483647, "Margin on y-axis from original doll position.");
