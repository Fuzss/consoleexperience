package fuzs.consoleexperience.client.tooltip;
...
public class TooltipElements {
    ...
    public static class Name extends TooltipElementBase.Text {
        ...
        protected List<ITextComponent> build(ItemStack itemstack, @Nullable PlayerEntity playerIn) {
            ...
            IFormattableTextComponent iformattabletextcomponent = new StringTextComponent("").append(itemstack.getDisplayName()).withStyle(itemstack.getRarity().color);
    ...
    public static class Information extends TooltipElementBase.Text {
        ...
        protected List<ITextComponent> build(ItemStack itemstack, @Nullable PlayerEntity playerIn) {
            ...
            if (!this.itooltipflag.isAdvanced() && !itemstack.hasCustomHoverName() && itemstack.getItem() == Items.FILLED_MAP) {

                tooltip.add(new StringTextComponent("#" + FilledMapItem.getMapId(itemstack)).withStyle(TextFormatting.GRAY));
            }
            ...
            try {
                ...
                if (testHiddenFlags(itemstack, ItemStack.TooltipDisplayFlags.ADDITIONAL)) {
                    ...
                    if (Block.byItem(itemstack.getItem()) instanceof ShulkerBoxBlock) {
                        ...
                        itemstack.getItem().appendHoverText(itemstack, playerIn != null ? playerIn.level : null, tooltip, this.itooltipflag);
                    }
                }
            ...
            tooltip.forEach(itextcomponent -> this.setDefaultableStyle(itextcomponent.copy()));
        ...
        public void deserialize(@Nullable JsonElement element) {
            ...
            if (element != null && element.isJsonObject()) {
                ...
                JsonObject jsonobject = JSONUtils.convertToJsonObject(element, "tooltip_" + this.getName());
        ...
        protected List<ITextComponent> build(ItemStack itemstack, @Nullable PlayerEntity playerIn) {
            ...
            if (itemstack.hasTag() && testHiddenFlags(itemstack, ItemStack.TooltipDisplayFlags.ENCHANTMENTS)) {
                ...
                for(int i = 0; i < listNBT.size(); i++) {
                    ...
                    ResourceLocation enchantmentLocation = ResourceLocation.tryParse(compoundnbt.getString("id"));
                    ...
                    enchantmentEntry.ifPresent(enchantment -> {
                        ...
                        ITextComponent itextcomponent = enchantment.getFullname(compoundnbt.getInt("lvl"));
                        tooltip.add(this.setDefaultableStyle(itextcomponent.copy()));
                    });
                }
            ...
            if (itemstack.hasTag()) {
                ...
                if (itemstack.getTag().contains("display", 10)) {
                    ...
                    if (testHiddenFlags(itemstack, ItemStack.TooltipDisplayFlags.DYE) && compoundnbt.contains("color", 99)) {
                        ...
                        return Lists.newArrayList(iformattabletextcomponent.withStyle(this.getStyle()));
                    }
                }
            }
                    ...
                    if (compoundnbt.getTagType("Lore") == 9) {
                        ...
                        for (int i = 0; i < listnbt.size(); i++) {
                            ...
                            try {
                                ...
                                IFormattableTextComponent iformattabletextcomponent = ITextComponent.Serializer.fromJson(listnbt.getString(i));
            ...
            if (testHiddenFlags(itemstack, ItemStack.TooltipDisplayFlags.MODIFIERS)) {
                ...
                for(EquipmentSlotType equipmentslottype : EquipmentSlotType.values()) {
                    ...
                    if (!multimap.isEmpty()) {
                        ...
                        IFormattableTextComponent iformattabletextcomponent = this.setDefaultableStyle(new TranslationTextComponent("item.modifiers." + equipmentslottype.getName()).withStyle(TextFormatting.GRAY));
                        ...
                        for(Map.Entry<Attribute, AttributeModifier> entry : multimap.entries()) {
                            ...
                            if (playerIn != null) {
                                ...
                                if (attributemodifier.getId().equals(UUID.fromString("CB3F55D3-645C-4F38-A497-9C13A33DB5CF"))) {
                                    ...
                                    amount += playerIn.getAttributeBaseValue(Attributes.ATTACK_DAMAGE);
                                    amount += EnchantmentHelper.getDamageBonus(itemstack, CreatureAttribute.UNDEFINED);
                                    isKnownModifier = true;
                                } else if (attributemodifier.getId().equals(UUID.fromString("FA233E1C-4180-4865-B01B-BCCE9785ACA3"))) {

                                    amount += playerIn.getAttributeBaseValue(Attributes.ATTACK_SPEED);
                                    isKnownModifier = true;
                                }
                            }
                            ...
                            if (isKnownModifier) {
                                ...
                                tooltip.add(this.setDefaultableStyle(new StringTextComponent(" ").append(new TranslationTextComponent("attribute.modifier.equals." + attributemodifier.getOperation().toValue(), ItemStack.ATTRIBUTE_MODIFIER_FORMAT.format(adjustedAmount), new TranslationTextComponent(entry.getKey().getDescriptionId()))).withStyle(TextFormatting.DARK_GREEN)));
                            } else if (amount > 0.0D) {

                                tooltip.add(this.setDefaultableStyle(new TranslationTextComponent("attribute.modifier.plus." + attributemodifier.getOperation().toValue(), ItemStack.ATTRIBUTE_MODIFIER_FORMAT.format(adjustedAmount), new TranslationTextComponent(entry.getKey().getDescriptionId())).withStyle(TextFormatting.BLUE)));
                            } else if (amount < 0.0D) {

                                adjustedAmount *= -1.0D;
                                tooltip.add(this.setDefaultableStyle(new TranslationTextComponent("attribute.modifier.take." + attributemodifier.getOperation().toValue(), ItemStack.ATTRIBUTE_MODIFIER_FORMAT.format(adjustedAmount), new TranslationTextComponent(entry.getKey().getDescriptionId())).withStyle(TextFormatting.RED)));
                            }
                        }
    ...
    public static class Durability extends TooltipElementBase.Text {
        ...
        protected List<ITextComponent> build(ItemStack itemstack, @Nullable PlayerEntity playerIn) {
            ...
            if (itemstack.isDamaged()) {
                ...
                IFormattableTextComponent iformattabletextcomponent = new TranslationTextComponent("item.durability", itemstack.getMaxDamage() - itemstack.getDamageValue(), itemstack.getMaxDamage());
                return Lists.newArrayList(iformattabletextcomponent.withStyle(this.getStyle()));
            }
    ...
    public static class NBTAmount extends TooltipElementBase.Text {
        ...
        protected List<ITextComponent> build(ItemStack itemstack, @Nullable PlayerEntity playerIn) {
            ...
            if (itemstack.hasTag()) {
                ...
                assert itemstack.getTag() != null;
                IFormattableTextComponent iformattabletextcomponent = new TranslationTextComponent("item.nbt_tags", itemstack.getTag().getAllKeys().size());
                return Lists.newArrayList(iformattabletextcomponent.withStyle(this.getStyle()));
            }
