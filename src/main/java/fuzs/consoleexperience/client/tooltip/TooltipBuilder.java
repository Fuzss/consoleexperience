...
public class TooltipBuilder {
    ...
    private static final Map<String, TooltipElementBase> TOOLTIP_ELEMENTS = Lists.newArrayList(
            ...
            new TooltipElements.Lore(true, 10, 12, Style.EMPTY.withColor(TextFormatting.DARK_PURPLE).withItalic(true)),
    ...
    private ITextComponent getLastLine(int amount) {
        ...
        return new TranslationTextComponent("container.shulkerBox.more", amount).withStyle(((SelectedItemElement) GameplayElements.SELECTED_ITEM).textColor, TextFormatting.ITALIC);
    }
